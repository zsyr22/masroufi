-- =========================================================
-- Masroufi
-- Migration: 027 - Purchase package size semantics
--
-- quantity = number of purchased units/packages
-- unit = how the item was sold (piece, pack, box, kg...)
-- package_size/package_unit = optional content of one unit (250 g, 330 ml...)
-- line_total remains quantity * unit_price.
-- =========================================================

alter table public.purchase_items
  add column if not exists package_size numeric(12,3)
    check (package_size is null or package_size > 0),
  add column if not exists package_unit public.purchase_unit;
...
begin
  ...
  insert into public.transactions(
    ...
    coalesce(nullif(trim(p_notes), ''), 'Itemized purchase · ' || v_store.name)
