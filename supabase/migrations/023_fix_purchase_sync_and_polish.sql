-- =========================================================
-- Masroufi
-- Migration: 023 - Fix purchase synchronization flag
-- =========================================================

-- Migration 020 standardized source-owned transaction synchronization on
-- app.masroufi_source_sync. Recreate update_purchase with the same flag so
-- purchase edits can safely update their linked transaction.
